...
public class RenderPhotonTorpedo extends Render {
	private static final ResourceLocation torpedoTextures = new ResourceLocation("minetrek:textures/entity/photonTorpedo.png");
	public RenderPhotonTorpedo(RenderManager renderManager) {
		super(renderManager);
	}
	@Override
	protected ResourceLocation getEntityTexture(Entity par1Entity) {
		return torpedoTextures;
	}
	@Override
	public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
		this.renderArrow((EntityPhotonTorpedo) par1Entity, par2, par4, par6, par8, par9);
	}
	public void renderArrow(EntityPhotonTorpedo entity, double par2, double par4, double par6, float par8, float par9) {
