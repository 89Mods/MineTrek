...
public class ParticleAcceleratorGui extends GuiContainer {
	public static final ResourceLocation texture = new ResourceLocation("minetrek", "textures/gui/particleAccelerator.png");
	private final ParticleAcceleratorTileEntity entity;
	public ParticleAcceleratorGui(InventoryPlayer invPlayer, ParticleAcceleratorTileEntity entity) {
		super(new ParticleAcceleratorContainer(invPlayer, entity));
		xSize = 176;
		ySize = 165;
		this.entity = entity;
	}
