...
public class GuiCoalGenerator extends GuiContainer {
	public static final ResourceLocation texture = new ResourceLocation("minetrek", "textures/gui/coalGenerator.png");
	private IInventory entity;
	private InventoryPlayer playerInventory;
	public GuiCoalGenerator(InventoryPlayer invPlayer, IInventory generator) {
		super(new ContainerCoalGenerator(invPlayer, generator));
