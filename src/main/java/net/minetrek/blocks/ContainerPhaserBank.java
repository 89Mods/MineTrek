...
public class ContainerPhaserBank extends Container {
	private TileEntityPhaserBank entity;
	public ContainerPhaserBank(InventoryPlayer invPlayer, TileEntityPhaserBank entity) {
		this.entity = entity;
		// Hotbar
		for (int x = 0; x < 9; x++) {
