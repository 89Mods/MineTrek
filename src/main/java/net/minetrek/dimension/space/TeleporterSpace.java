...
public class TeleporterSpace extends Teleporter {
    ...
    public TeleporterSpace(WorldServer worldIn)
    {
    	super(worldIn);
    ...
    public boolean placeInExistingPortal(Entity entityIn, float p_180620_2_)
    {
        ...
        {
            TeleporterSpace.PortalPosition portalposition = (TeleporterSpace.PortalPosition)this.destinationCoordinateCache.getValueByKey(k);
            d0 = 0.0D;
        ...
        if (d0 >= 0.0D)
        {
            if (flag1)
            {
                this.destinationCoordinateCache.add(k, new TeleporterSpace.PortalPosition((BlockPos)object, this.worldServerInstance.getTotalWorldTime()));
    ...
    public void removeStalePortalLocations(long p_85189_1_)
    {
        if (p_85189_1_ % 100L == 0L)
        {
            ...
            while (iterator.hasNext())
            {
                ...
                TeleporterSpace.PortalPosition portalposition = (TeleporterSpace.PortalPosition)this.destinationCoordinateCache.getValueByKey(olong.longValue());
